...
def cadastro(request):
    if request.method == 'GET':
        ...
        try:
            ...
            messages.add_message(request, constants.SUCCESS, 'Usúario cadastrado com sucesso')
...
def logar(request):
    if request.method == 'GET':
        ...
        if not usuario:
            messages.add_message(request, constants.ERROR, 'Usúario ou senha inválido')
            return redirect('/auth/logar')
        else:
